export const units = {
  ...
  caravan: {
    name: "Caravan",
    resume:
      "Caravan drivers are a specialization of the wanderers, making more space available for cargo and greater speed given the use of large wagons pulled by animals",
    description:
      "This type of unit should never do missions alone because it does not have serious weapons or other technologies, in order to provide maximum space for transport. Caravans can quickly supply planets thanks to their large chariots. Of course this unit is used in armies to recover as many resources as possible from the attacked territories.",
    icon: "general",
    type: "civilian",
    stats: {
      health: 12000,
  ...
  spy: {
    name: "Spy",
    resume:
      "Lespies are small familiar animals trained to be exceptionally fast and operate in the shadows. They are used to spy on foreign territories.",
    description:
      "Spies are small familiars who can send spying information from great distances in seconds. They use their animal aspect to gather information and, at the same time, redirect to their homeland. While in enemy territory, they are particularly easy to detect. Having no cover, armor or weapons, they are particularly vulnerable to defensive structures and enemy armies if identified.",
    icon: "general",
    type: "civilian",
    stats: {
      health: 1000,
  ...
  jackal: {
    name: "Jackals",
    resume:
      "Jackals are units used to collect debris that form on battlefields and recycle useful resources.",
    description:
  ...
  archer: {
    name: "Archers",
    resume:
      "The prison is a maneuverable infantry unit found on nearly every kingdom. The costs are not particularly high but at the same time the strength of the armor and the space for transport are very limited.",
    description:
      "Due to their light armor and rudimentary weapons, archers belong to the support units in battle. Their agility and speed coupled with the amount of units they attack can make them appear as a diversion from larger troops who are not as maneuverable.",
    icon: "general",
    type: "military",
    stats: {
      health: 4000,
  ...
  infantryman: {
    name: "Infantryman",
    resume:
      "The infantry soldier is the direct counterpart of the archer and offers greater armor and greater attack power.",
    description:
      "During the training of the infantry units the blacksmiths reached the point where the forging techniques reached their limits. To provide the necessary agility for new soldiers, a new type of material was used for the first time. Despite the additional cost and complexity, new possibilities have been revealed in part due to the higher cost of the materials generally used. Through the use of horse hide and river dragon scales, more lightness and hardness have been made available for weapons and armor. Improved armor and superior armament make this unit a much greater threat than normal archery units.",
    icon: "general",
    type: "military",
    stats: {
      health: 10000,
  ...
  crossbowman: {
    name: "Crossbowman",
    resume:
      "Crossbowmen are at least three times more armored than archers and have more than double the firepower at their disposal. Their speed of movement is likewise superior to anything else seen before.",
    description:
  ...
  knight: {
    name: "Knights",
    resume:
      "The Knights are the backbone of any military group. Reinforced armor, heavy weaponry and high displacement speeds make this unit, together with the large space for resources, a difficult enemy to defeat.",
    description:
      "The Knights are the backbone of any military battalion. Their reinforced armor, combined with heavy armament, and a high cruising speed, make this unit indispensable for any empire. It also has a large load capacity which is great in hostile situations.",
    icon: "general",
    type: "military",
    stats: {
      health: 60000,
  ...
  neuromancer: {
    name: "Neuromancer",
    resume:
      "The neuromancer is a special mystical unit developed to break through and incapacitate enemy defenses.",
    description:
      "The Neuromancer is a special mystical unit developed to incapacitate heavy enemy defenses. Thanks to a great knowledge in the art of neuromancy, they can directly attack the minds of enemy defenders, causing enormous destruction among the enemy units. Neuromancers base speed is increased as soon as level 8 Eagle Training is researched as they become capable of riding these majestic birds.",
    icon: "general",
    type: "military",
    stats: {
      health: 75000,
  ...
  dragon: {
    name: "Dragon",
    resume:
      "Dragon units are a powerful tool of destruction capable of plundering resources immediately after battles.",
    description:
      "Draconic units are the rulers of war units: it combines power, rugged armor, speed and skill. Furthermore, it is the only one able to instantly exploit part of the resources created after the battle. Their impressive speed is balanced by a considerable cost in terms of food.",
    icon: "general",
    type: "military",
    stats: {
      health: 140000,
